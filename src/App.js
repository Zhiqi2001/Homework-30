...
const KanbanBoard = () => {
  ...
  return (
    <div className="grid max-w-5xl grid-cols-4 py-40 mx-auto font-mono gap-x-4">
      {col.map((v, i) => (
        <Column
          index={i}
...
function Column({
  ...
  return (
    <div className="relative w-full">
      <div
        className={`flex items-center justify-center w-full py-2.5 px-4 rounded-t-xl font-mono shadow-2xl ${data.color}`}
      >
      ...
      <div className="relative">
        <input
          className="w-full p-2.5 font-mono rounded-b-xl shadow-2xl"
          onKeyDown={(e) => {
            if (e.key === "Enter") {
              handleAddTodo(index);
            }
...
function Item({
  ...
  return (
    <div className="flex w-full hover:space-x-2 group">
      ...
      <div className="flex items-center justify-center w-0 duration-75 bg-black cursor-pointer rounded-xl group-hover:w-1/4 hover:bg-red-600">
        <TrashIcon
